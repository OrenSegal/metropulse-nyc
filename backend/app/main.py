...
class GeoEngine:
    ...
    def get_borough(lat, lon):
        ...
        if lat < 40.70 and lon > -73.86:
            return "Queens"  # Ozone Park
...
class RuleBasedNarrative:
    ...
    def generate(borough, vitality, office, uni, time_dna):
        ...
        if uni > 2:
            character_type = "Academic"
        elif vitality > 75 and time_dna['night'] > 40:
            character_type = "Nightlife"
        elif office > 70:
            character_type = "Corporate"
        elif office > 50 and vitality > 50:
            character_type = "Mixed-Use"
        elif time_dna['morning'] > 60:
            character_type = "Commuter"
        elif vitality < 20 and office < 20:
            character_type = "Residential"
        ...
        if character_type == "Academic":
            ...
            vibe_desc = "A dense commercial district dominated by office buildings and professional services."
        ...
        if peak_time == "morning":
            ...
            time_desc = (
                "Passenger volume swells in the Evening (4-8pm) as the "
                "workday ends and retail activity picks up."
            )
        elif peak_time == "night":
            time_desc = (
                "Unusually high Late Night (10pm-4am) ridership signals "
                "a destination for after-hours entertainment."
            )
        else:
